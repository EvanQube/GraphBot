...
client.on('message', msg => {
  ...
  else if (command === 'unban') {client.commands.get('unban').execute(msg, args, Discord, client);}
  ...
  else if (command === 'unmute') {client.commands.get('unmute').execute(msg, args, ms, Discord);}
